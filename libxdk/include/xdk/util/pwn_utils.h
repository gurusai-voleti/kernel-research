 ...
 * @param window_size The size of the sliding window for median filtering.
 ...
 */
uint64_t leak_kaslr_base(int samples = 100, int trials = 3, int window_size = 28, std::vector<std::vector<uint64_t>>* debug_data = nullptr);